...
if (isset($_POST["submit"])) {
    ...
    $tanggal_mapaba = $_POST["tanggal_mapaba"];
    $tempat_mapaba = $_POST["tempat_mapaba"];

    if ($user['status'] == 'Mapaba') {
        echo "
            <script>
            alert('Anda telah terdaftar Menjadi Mapaba');
            document.location.href='index.php';
            </script>
            ";
    } elseif ($user['status'] == 'PKD') {
        echo "
                    <script>
                    alert('Anda telah terdaftar Menjadi Mapaba');
                    document.location.href='index.php';
        ...
        $tambah = sql("INSERT INTO mapaba (id_user,tempat_mapaba,tanggal_mapaba) VALUES ('$id','$tanggal_mapaba','$tempat_mapaba')");
    ...
    <div class="container pt-5">
        <div class="row g-5 pt-5">
            <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                <h1 class="display-4 text-white mb-4 animated slideInRight">MAPABA</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center justify-content-lg-start mb-0">
                        <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a class="text-white" href="index.php#kaderisasi">Kaderisasi</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">MAPABA</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container mb-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-md-6 px-5 newsletter-text wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="position-relative w-100 mt-3 mb-2">
                    <label for="" class="mb-2 px-2 text-white">Tanggal Mapaba</label>
                    <input class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="date" placeholder="Masukan Tanggal" name="tanggal_mapaba" style="height: 48px;" required>
                </div>
                <div class="position-relative w-100 mt-3 mb-2">
                    <label for="" class="mb-2 px-2 text-white">Tempat Mapaba</label>
                    <select class="form-select-lg form-control border-0 rounded-pill w-100 ps-4 pe-5" aria-label="Default select example" required name="tempat_mapaba">
                ...
                <div class="position-relative w-100 mt-4 mb-2">
                    <button type="submit" name="submit" style="width: 520px;" class="btn btn-warning rounded-pill shadow-none position-absolute top-0 end-0 mt-1 me-2"><span class="text-white">Daftar Mapaba </span><i class="fa fa-paper-plane text-white fs-4 px-3"></i></button>
                </div>
                </form>
            </div>
        </div>
