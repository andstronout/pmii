...
$sql_user = sql("SELECT * FROM user WHERE `level`='1' AND `status`='Calon Anggota' AND pengajuan='yes' ");
$no = 1;
?>
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Data Pendaftaran Mapaba</h1>
  </div>
          ...
          <tbody>
            <?php foreach ($sql_user as $user) : ?>
              <tr>
                ...
                <th>
                  <a href="terima_mapaba.php?id=<?= $user['id_user']; ?>" class="btn btn-sm btn-success" onclick="return confirm('Terima untuk jadi anggota?')">Terima Anggota</a>
                </th>
              </tr>
            <?php
              $no++;
