  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        <div class="sidebar-brand-text mx-3">PMII <br> <sup>KabTang</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">List Pengajuan</h6>
            <a class="collapse-item" href="daftar_calon.php">Pengajuan Mapaba</a>
            <a class="collapse-item" href="daftar_mapaba.php">Pengajuan PKD</a>
            <a class="collapse-item" href="daftar_pkd.php">Pengajuan PKL</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Kelola anggota -->
      <li class="nav-item active">
        <a class="nav-link" href="daftar_anggota.php">
