...
$id = $_GET["id"];
$sql_produk = sql("SELECT * FROM transaksi INNER JOIN produk ON transaksi.id_produk=produk.id_produk WHERE id_transaksi='$id'");
$no = 1;

$cek = sql("SELECT status_transaksi FROM transaksi WHERE id_transaksi='$id'");
$hasil = $cek->fetch_assoc();


if (isset($_POST["submit"])) {
  $update_transaksi = sql("UPDATE transaksi SET `status_transaksi`='Sedang Diproses' WHERE id_transaksi='$id'");
  echo "
        <script>
      ...
      <form action="" method="post">
        <div class="row">
          ...
          <div class="col-2">
            ...
            <?php if ($hasil['status_transaksi'] == 'Belum Diproses') { ?>
